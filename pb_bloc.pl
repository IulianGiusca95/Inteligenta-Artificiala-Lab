pb_bf :-initial(S), rezolva_b(S, Solutie), write(Solutie). %apeleaza algoritmul in varianta BF
pb_df :-initial(S), rezolva(S, Solutie),write(Solutie). %apeleaza algoritmul in varianta DF
